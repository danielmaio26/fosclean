...
if (isset($_POST['submit'])) {
    ...
    if (count($errors) == 0) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'info@fosclean.com';
            $mail->Password = 'Fos13915563';
            $mail->SMTPSecure = 'tls';
            $mail->Port = 587;

            $mail->setFrom('info@fosclean.com', 'Emisor');
            $mail->addAddress('info@fosclean.com', 'Receptor');
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    ...
                    <form class="form" method="POST" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" autocomplete="off">
                        ...
                        <div class="mb-3">
                            <div class="g-recaptcha" data-sitekey="6LegTIggAAAAAF-voQV3SDWhdc9k0zvxETZxUKXc"></div>
                        </div>
